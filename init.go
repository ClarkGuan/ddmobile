...
func installOpenAL(gomobilepath string) error {
	...
	if !hasNDK() {
		return errors.New("The Android NDK is needed to build OpenAL but it was not found. Please run ddmobile init with the ndk-bundle installed through the Android SDK manager or with the -ndk flag set.")
	}
